document.addEventListener('DOMContentLoaded', () => {
  ...
  chatbotIcon.addEventListener('click', () => {
    ...
    chatbotIcon.style.display = 'none'; // Hide icon when chat is open
    chatBody.innerHTML = ''; // Clear chat history
    addBotMessage("Hello! I'm GMU AI Assistant. How can I help you navigate today?");
  });

  closeChatBtn.addEventListener('click', () => {
    chatWindow.style.display = 'none';
    chatbotIcon.style.display = 'flex'; // Show icon when chat is closed
    if (isListening) {
        recognition.stop();
        isListening = false;
